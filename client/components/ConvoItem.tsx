...
import { formatTime } from '@/utilss/formatTime';
...
export default function ConvoItem({convo, selected, onPress}:
    ConvoItemProps) {
        ...
        const lastMsg = convo.lastMessage?.text || (convo.lastMessage?.mediaType
            === "image" ? "📷 photo" : convo.lastMessage?.mediaUrl ?
        ...
        <View style={styles.info}>
            <View style={styles.topRow}>
                ...
                {convo.updatedAt && <Text style={styles.time}>
                    {formatTime(convo.updatedAt)}</Text>}
            </View>
