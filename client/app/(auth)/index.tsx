        ...
        keyboardShouldPersistTaps='handled'>
          ...
          <Text style={styles.heading}>Verify Email</Text>
            ...
            <View style={styles.form}>
              ...
              {/* submit */}
              <TouchableOpacity disabled={loading} activeOpacity={0.88}
              style={styles.btnWrapper} onPress={handleVerify}>
                <LinearGradient colors={[Colors.primary,Colors.primaryContainer]}
                start={{x:0, y:0}}
                end={{x:1, y:1}}
                style={styles.btn}>
            ...
            <View style={styles.form}>
              ...
              <View style={styles.toggleRow}>
                ...
                <TouchableOpacity onPress={()=>setMode(mode ===
                  ...
                  <Text style={styles.toggleLink}>{mode === 'login' ?
              ...
              {/* submit */}
              <TouchableOpacity disabled={loading} activeOpacity={0.88}
              style={styles.btnWrapper} onPress={handleSubmit}>
                <LinearGradient colors={[Colors.primary,Colors.primaryContainer]}
                start={{x:0, y:0}}
                end={{x:1, y:1}}
                style={styles.btn}>
